...
router.get("/:address", async (req, res) => {
    ...
    let filename = `./data/${address}/`;
    const securityCacheFile = path.join(__dirname, `../data/${address}/security.json`);
    const rugpullCacheFile = path.join(__dirname, `../data/${address}/rugpull.json`);
    const tokenCacheFile = path.join(__dirname, `../data/${address}/token.json`);
    const metadataCacheFile = path.join(__dirname, `../data/${address}/meta.json`);
    ...
    const findingsCacheFile = path.join(__dirname, `../data/${address}/findings.json`);
