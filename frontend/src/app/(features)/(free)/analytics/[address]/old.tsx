...
import { TopHolding } from '@/components/analytics/graphs/top-holding';
...
import TokenDetailOverView from '@/components/analytics/overview';
import TransferVolumeGraph from '@/components/analytics/graphs/volume';
import HoldersGraph from '@/components/analytics/graphs/holders';
import {
  Select,
  SelectContent,
  SelectGroup,
