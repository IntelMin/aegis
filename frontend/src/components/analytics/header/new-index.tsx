...
const NewTokenHeader = ({ showTitle, metadata, liveData }: Props) => {
              ...
              <div className="max-md:w-full flex flex-col items-center justify-center w-fit gap-3">
                ...
                >
                  <PaymentDialog
                    ...
                    onSuccess={() => {
                      setSubmitting(true);
                      router.push(`/audit/token/${metadata?.address || '0x55a8f6c6b3aa58ad6d1f26f6afeded78f32e19f4'}/quick`);
                    }}
                  />
                </div>
              </div>
