...
export const GraphTypeHeader = (props: {
  ...
  return (
    <Select onValueChange={props.handleTypeChange}>
      <SelectTrigger className="w-full md:w-[180px] bg-zinc-900 rounded-[4px] outline-none p-2 py-1 text-white">
        <div className="flex justify-between items-center text-sm">
          {props.choosenType}
          <BiChevronDown className="text-neutral-400 text-[28px]" />
        </div>
      </SelectTrigger>
      <SelectContent className="w-full md:w-[180px] bg-zinc-900 text-white pointer rounded-[4px] overflow-auto">
        <SelectGroup>
