...
const OverViewReport = (props: Props) => {
  ...
  return (
    <div className="py-12 w-full px-10 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-11 gap-5">
        ...
        <div className="col-span-5 flex flex-col gap-5">
          ...
          <AuditHistory />
          {/* Audit Details */}
          <div className="w-full p-6 flex flex-col gap-4 border border-zinc-900">
                ...
                {labels?.map((item, i) => (
                  <div key={item} className="flex items-center gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <p className="text-neutral-200 text-[16px] tracking-[1px]">{item}:</p>
                    </div>
                    <p>{series[i]}</p>
                  </div>
                ))}
