...
const TokenDescription = (props: Props) => {
  return (
    <div>
      <div>
        <h1 className="text-neutral-200 text-[16px] font-[600]">TOKEN DESCRIPTION</h1>
      ...
      <div className="flex items-center gap-4 mt-3">
        <Link href="#" className="bg-zinc-900 p-2 rounded-[6px]">
            <Image src="/token-icons/webicon.svg" alt="social-icon" width={18} height={18} />
        </Link>
        <Link href="#" className="bg-zinc-900 p-2 rounded-[6px]">
            <Image src="/token-icons/twitter.svg" alt="social-icon" width={18} height={18} />
        </Link>
        <Link href="#" className="bg-zinc-900 p-2 rounded-[6px]">
            <Image src="/token-icons/tele.svg" alt="social-icon" width={18} height={18} />
        </Link>
      </div>
    </div>
  );
